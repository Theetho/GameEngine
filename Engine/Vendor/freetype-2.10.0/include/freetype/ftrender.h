...
FT_BEGIN_HEADER
  ...
  typedef void
  (*FT_Glyph_Transform3DFunc)( FT_Glyph          glyph,
...
#define FT_Glyph_Transform3D_Func  FT_Glyph_Transform3DFunc
...
#define FT_Glyph_Prepare_Func    FT_Glyph_PrepareFunc
  ...
  struct  FT_Glyph_Class_
  {
    ...
    FT_Glyph_Transform3DFunc  glyph_transform;
  ...
  typedef FT_Error
  (*FT_Renderer_Transform3DFunc)( FT_Renderer       renderer,
                                FT_GlyphSlot      slot,
                                const FT_Matrix*  matrix,
                                const FT_Vector*  delta );
...
#define FTRenderer_transform  FT_Renderer_Transform3DFunc
...
#define FTRenderer_setMode  FT_Renderer_SetModeFunc
  ...
  typedef struct  FT_Renderer_Class_
  {
    ...
    FT_Renderer_Transform3DFunc  transform_glyph;
