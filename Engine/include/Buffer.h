...
/// Abstract base classes
	...
	public:
		...
		static VertexBuffer* create(float* vertices, const unsigned int& size);
	};
	...
	public:
		...
		static IndexBuffer* create(unsigned int* indices, const unsigned int& size);
	};
...
/// OpenGL buffers
	...
	{
	public:
		OpenGLVertexBuffer(float* vertices, const unsigned int& size);
		~OpenGLVertexBuffer();
	...
	{
	public:
		OpenGLIndexBuffer(unsigned int* indices, const unsigned int& size);
		~OpenGLIndexBuffer();
